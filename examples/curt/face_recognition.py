...
worker's database. A new person is first added to the database. Then the face 
recognition worker can recognize this person. The person is then deleted after 30 
